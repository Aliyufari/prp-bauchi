        ...
        <div class="flex-1 flex flex-col items-center justify-center px-4 sm:px-8 lg:px-12 xl:px-16 py-8 sm:py-12">
            ...
            <div class="w-full max-w-sm">
                ...
                <div class="mb-6 sm:mb-8">
                    <h2 class="text-[#111827] font-black text-xl sm:text-2xl tracking-tight">Sign in to your account</h2>
                ...
                <form @submit.prevent="submit" novalidate>
                    <div class="flex flex-col gap-5">
                        ...
                        <label class="flex items-center gap-2.5 cursor-pointer select-none group w-fit">
                            <div class="relative flex-shrink-0">
                                <input id="remember" v-model="form.remember" type="checkbox" :tabindex="3" class="sr-only peer" />
                                <div
                                    :class="[
                                        'w-4 h-4 rounded border-2 transition-all duration-150 flex items-center justify-center',
                                        form.remember ? 'bg-[#16a34a] border-[#16a34a]' : 'bg-white border-[#d1d5db] group-hover:border-[#16a34a]/50',
                                    ]"
