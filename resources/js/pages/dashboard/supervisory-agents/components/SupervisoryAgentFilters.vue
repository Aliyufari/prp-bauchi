...
import type { SupervisoryAgentFilterOptions } from '@/types/supervisory-agent'

interface Props {
  modelValue: Record<string, string>
  options: SupervisoryAgentFilterOptions
}
...
const filters = computed<FilterDef[]>(() => [
  ...
  { key: 'type', label: 'Level', options: props.options.types },
