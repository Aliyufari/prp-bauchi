...
import type { StakeholderTypeOption } from '@/types/stakeholder'
  ...
  <form @submit.prevent="emit('submit')" class="space-y-6">
    ...
    <fieldset class="space-y-4">
      ...
      <div v-if="'password' in form" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label class="mb-1 block text-xs font-medium text-gray-600">Stakeholder ID</label>
          <input
    ...
    <!-- Stakeholder details -->
    <fieldset class="space-y-4">
      <legend class="text-xs font-bold uppercase tracking-wide text-gray-400">Stakeholder details</legend>
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label class="mb-1 block text-xs font-medium text-gray-600">Organization</label>
          <input
            v-model="form.organization"
            type="text"
            placeholder="e.g. Emirate Council, NGO name"
            class="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>

        <div>
          <label class="mb-1 block text-xs font-medium text-gray-600">Designation</label>
          <input
            v-model="form.designation"
            type="text"
            placeholder="e.g. District Head, Chairman"
            class="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>
      </div>
