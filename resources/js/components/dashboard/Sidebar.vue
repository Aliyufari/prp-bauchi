...
import {
  ...
  Settings, Key, ScrollText, HardDrive, ChevronRight, Building2
...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: 'Party Agents', route: '/party-agents', icon: 'UserCheck' },
      { label: 'Coordinators', route: '/coordinators', icon: 'Briefcase' },
      { label: 'Stakeholders', route: '/stakeholders', icon: 'Handshake' },
      { label: 'Returning Officers', route: '/returning-officers', icon: 'RotateCcw' },
      { label: 'Supervisory Agents', route: '/supervisory-agents', icon: 'Shield' },
    ],
  },
  {
    group: 'Election Management',
    items: [
      { label: 'Aspirant (Governor)', route: '/aspirant', icon: 'Vote' },
      { label: 'All Aspirants', route: '/aspirants', icon: 'Users' },
      { label: 'Election Calendar', route: '/election-calendar', icon: 'Calendar' },
      { label: 'Polling Units', route: '/polling-units', icon: 'MapPin' },
      { label: 'Campaign Teams', route: '/campaign-teams', icon: 'Users2' },
      { label: 'Results Management', route: '/results', icon: 'BarChart3' },
    ],
  },
  {
...
<template>
  ...
  >
    <!-- Logo -->
    <div
      :class="['flex items-center gap-3 px-4 py-4 border-b', collapsed ? 'justify-center' : '']"
    ...
    <!-- Footer -->
    <div
      :class="['p-3 border-t', collapsed ? 'flex justify-center' : '']"
      style="border-color: rgba(255,255,255,0.08); background: rgba(0,0,0,0.25);"
    >
      <div :class="['flex items-center gap-3', collapsed ? 'justify-center' : 'px-1']">
        <div
