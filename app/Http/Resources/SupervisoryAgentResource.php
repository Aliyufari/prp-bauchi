...
class SupervisoryAgentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'agent_no' => $this->profile?->application_id,
            'phone' => $this->profile?->phone,
            'gender' => $this->profile?->gender,
            'occupation' => $this->profile?->occupation,
            'education_status' => $this->profile?->education_status,

            'supervisor_type' => $this->supervisoryAgent?->type?->value,
            'supervisor_type_label' => $this->supervisoryAgent?->type
                ? ucwords(str_replace('_', ' ', strtolower($this->supervisoryAgent->type->value)))
                : null,
            'agents_supervised' => $this->supervisoryAgent?->agents_supervised ?? 0,
