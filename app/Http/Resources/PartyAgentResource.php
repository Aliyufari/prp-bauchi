...
class PartyAgentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'agent_type' => $this->partyAgent?->type?->value,
            'agent_type_label' => $this->partyAgent?->type
                ? ucwords(str_replace('_', ' ', strtolower($this->partyAgent->type->value)))
                : null,
            ...
            // "Deployed" = assigned down to a polling unit; "unassigned" = not yet.
            'deployed' => (bool) $this->profile?->pu_id,
