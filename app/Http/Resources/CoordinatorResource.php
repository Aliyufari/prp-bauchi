...
class CoordinatorResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'coordinator_no' => $this->profile?->application_id,
            'phone' => $this->profile?->phone,
            'gender' => $this->profile?->gender,
            'occupation' => $this->profile?->occupation,
            'education_status' => $this->profile?->education_status,

            'coordinator_type' => $this->coordinator?->type?->value,
            'coordinator_type_label' => $this->coordinator?->type
                ? ucwords(str_replace('_', ' ', strtolower($this->coordinator->type->value)))
                : null,
